...
void measurePositonVel(struct readPosVel *read){
	...
	read->position2 = ds3001_read_position(DS3001_2_BASE,1)*100; 
	...
	read->position3 = ds3001_read_position(DS3001_1_BASE,4)*100; 
	
	if(read->position3 >=  read->position3_prev ){
		read->dir3= 1; 
	}
	else {
		read->dir3 = -1; 
	...
	read->position3_prev = read->position3; 
